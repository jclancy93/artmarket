...
@section('content')
    @if (count($artworks) > 0)
        ...
        <br>
         ...
         <h4 class="text-center" style="font-size: 20px; font-weight: 300; font-family: Lato !important;"><?php echo count($artworks)?> Results for "{{{ Input::get('query') }}}"</h4>
        ...
        <div class="row row-fluid">
            <div class="media" onclick="window.location='{{url('artwork/'.$artwork->id)}}'">
                ...
                <div class="media-body fnt-smaller col-md-8">
                    ...
                    <p class="hidden-xs">{{$artwork->art_fair}}</p><p class="fnt-smaller fnt-lighter fnt-arial">{{$artwork->gallery_name}}</p>
